const translations = {
  en: {
    ...
    testLineSpeed: "Line Speed",
    testTime: "Test Time",
    polyolWeight: "Polyol",
    isocyanateWeight: "Iso",
    polyolRPM: "Polyol RPM",
    isoRPM: "Iso RPM",
    ...
    errorMinValue: "Minimum value is",
    errorMaxValue: "Maximum value is"
  },
  vi: {
    ...
    testLineSpeed: "Tốc Độ Dây Chuyền",
    testTime: "Thời Gian Test",
    polyolWeight: "Polyol",
    isocyanateWeight: "Iso",
    polyolRPM: "Polyol RPM",
    isoRPM: "Iso RPM",
    ...
    newLineSpeed: "Tốc Độ Dây Chuyền",
    newConsumption: "Tiêu Hao",
    newRatio: "Tỷ Lệ",
    ...
    clipboardSuccess: "Đã sao chép vào clipboard!",
    errorRequired: "Trường này là bắt buộc",
    errorInvalidNumber: "Vui lòng nhập một số hợp lệ",
    errorMinValue: "Giá trị tối thiểu là",
    errorMaxValue: "Giá trị tối đa là"
  },
  th: {
    ...
    newLineSpeed: "ความเร็วสาย",
    newConsumption: "การใช้",
    newRatio: "อัตราส่วน",
    ...
    clipboardSuccess: "คัดลอกไปยังคลิปบอร์ดแล้ว!",
    errorRequired: "จำเป็นต้องกรอกช่องนี้",
    errorInvalidNumber: "กรุณาใส่ตัวเลขที่ถูกต้อง",
    errorMinValue: "ค่าต่ำสุดคือ",
    errorMaxValue: "ค่าสูงสุดคือ"
  },
  cn: {
    title: "PU喷涂机操作参数计算器",
